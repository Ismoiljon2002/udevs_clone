           ...
           <NavbarBrand href="#home">
            ...
            <NavbarCollapse className="justify-content-end align-items-center">
                <Nav >
                    ...
                    <NavLink href="#contact" className="btn -btn-primary">Contact</NavLink>
                </Nav>
            </NavbarCollapse> 
        </Container> 
    </Navbar>);
